...
public class TrackerStaticFieldLazyLoading {
    private static TrackerStaticFieldLazyLoading instance;

    private TrackerStaticFieldLazyLoading() {
    }

    public static TrackerStaticFieldLazyLoading getInstance() {
        if (instance == null) {
            instance = new TrackerStaticFieldLazyLoading();
        }
        return instance;
    }
