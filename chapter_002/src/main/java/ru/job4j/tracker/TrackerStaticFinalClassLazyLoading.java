...
public class TrackerStaticFinalClassLazyLoading {
    ...
    private static final class Holder {
        private static final TrackerStaticFinalClassLazyLoading INSTANCE = new TrackerStaticFinalClassLazyLoading();
    }

    public static TrackerStaticFinalClassLazyLoading getInstance() {
        return Holder.INSTANCE;
    }

    public static void main(String[] args) {
        TrackerStaticFinalClassLazyLoading tracker = TrackerStaticFinalClassLazyLoading.getInstance();
    }
