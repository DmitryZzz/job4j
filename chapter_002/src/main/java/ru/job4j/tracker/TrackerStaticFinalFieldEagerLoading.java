...
public class TrackerStaticFinalFieldEagerLoading {
    private final static TrackerStaticFinalFieldEagerLoading INSTANCE = new TrackerStaticFinalFieldEagerLoading();

    private TrackerStaticFinalFieldEagerLoading() {
    }

    public static TrackerStaticFinalFieldEagerLoading getInstance() {
        return INSTANCE;
    }
